...
<h1 class="h2 text-center mb-5 mt-5">Modification de l'enseignant : <?=$data[0]->getPrenom();?> <?=$data[0]->getNom();?></h1>
        ...
        <div class="col-4">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="mb-1">
                        <img src="./assets/images/enseignants/<?=$data[0]->getPhoto();?>" alt="photo de <?=$data[0]->getPrenom();?> <?=$data[0]->getNom();?>" width=150>
                    </div>
                    <input type="File" id="photo" name="photo" class="form-control">
                </div>
                <div class="form-group">
                    <label for="discours">Discours (uniquement pour le directeur sportif) :</label>
