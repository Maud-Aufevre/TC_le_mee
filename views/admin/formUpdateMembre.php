...
<h1 class="h2 text-center mb-5 mt-5">Modification du membre : <?=stripslashes($data[0]->getPrenom());?> <?=stripslashes($data[0]->getNom());?></h1>
        ...
        <div class="col-4">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="mb-1">
                        <img src="./assets/images/bureau/<?=$data[0]->getPhoto();?>" alt="photo de <?=stripslashes($data[0]->getPrenom());?> <?=stripslashes($data[0]->getNom());?>" width=150>
                    </div>
                    <input type="File" id="photo" name="photo" class="form-control">
                </div>
                <div class="form-group">
                    <label for="discours">Discours (uniquement pour le président) :</label>
                    <textarea name="discours" id="discours" cols="30" rows="10" class="form-control"><?=stripslashes($data[0]->getDiscours());?></textarea>
                </div>
